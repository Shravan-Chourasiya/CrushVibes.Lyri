...
export function SongListItem({ song, decodeHtmlEntities }: SongListItemProps) {
  return (
    <li className="flex items-center gap-3 p-3 hover:bg-muted/50 rounded-lg transition-colors">
      ...
      <button className="w-8 h-8 bg-primary hover:bg-primary/90 rounded-full flex items-center justify-center shrink-0 transition-colors">
